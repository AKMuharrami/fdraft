  ...
  const cardVariants = {
    ...
    return (
      ...
      <div style={{right:'10vh', textAlign:'center', paddingTop: 3}}>
           ...
           { isDesktopOrLaptop && <img style={{visibility:'visible',height:"80vh", width:"45vw", objectFit: "cover", objectPosition:"-6vw -7vh", marginTop:30, transition: 'all .20s', maxHeight:'50vh', maxWidth:'40vw'}} src="https://img.freepik.com/premium-photo/computer-with-lit-screen-that-says-cyberpunk-it_575980-1019.jpg?w=1800" alt="" />}
          ...
          { isTabletOrMobile &&<motion.div
           ...
           { isTabletOrMobile && <img style={{visibility:'visible',height:"37vh", width:"45vw", objectFit: "cover", objectPosition:"-23vw -6vh", marginTop:37, transition: 'all .20s', maxHeight:'50vh', maxWidth:'80vw'}} src="https://img.freepik.com/premium-photo/computer-with-lit-screen-that-says-cyberpunk-it_575980-1019.jpg?w=1800" alt="" />}
          ...
          {isTabletOrMobile &&<div>
              ...
              style={{fontSize:'13px',textAlign:"center", color:"white", WebkitTextStroke: '1px 0b0e13', marginBottom:'9vh'}}> * الآتي هو مثال لأحد طرق العرض من مشروع آخر <br></br>عن الطريق إلى الله تعالى<br></br> (لعرض بعض مهارات العرض)</motion.h2>
              </div>}
          </div>
          {isDesktopOrLaptop &&<div>
              ...
              viewport={{once:true, amount: 0.8}}
              variants={cardVariants}
              style={{fontSize:'17px',textAlign:"center", color:"white", WebkitTextStroke: '1px 0b0e13', marginBottom:'9vh'}}> * الآتي هو مثال لأحد طرق العرض من مشروع آخر <br></br>عن الطريق إلى الله تعالى<br></br> (لعرض بعض مهارات العرض)</motion.h2>
              </div>}
          {isDesktopOrLaptop &&<div>
              <motion.h2
              initial="offscreen"
              ...
              viewport={{once:true, amount: 0.8}}
              variants={cardVariants}
              style={{fontSize:'27px',textAlign:"center", color:"white",textShadow: '1px 1px 7px rgb(255 30 160 / 50%)', WebkitTextStroke: '1px 0b0e13' }}> معلوم لدينا أن في كل قصة/مغامرة <br></br> العناصر التالية هي المحاور الأساسية</motion.h2>
              ...
              style={{display:'flex', justifyContent:'space-around', direction:'rtl'}}>
                  <button onClick={() => {
                    ...
                    .then (() => {n()})
                   }} style={{background:'rgb(255, 255, 255, 0)', border:'0', }}><h3 style={{background:'white',borderRadius:'50px', fontSize:"18px", height:'10vh',width:'12vw',textAlign:'center',lineHeight:4}}>الشخصية الرئيسية</h3></button>
                  <button onClick={() => {
                    const bbb = new Promise ((resolve, reject) => {
                    setTimeout(() => {
                      resolve(n());
                    ...
                    .then (() => {n()})
                   }} style={{background:'rgb(255, 255, 255, 0)', border:'0', }}><h3 style={{background:'white',borderRadius:'50px', fontSize:"18px", height:'10vh',width:'10vw',textAlign:'center',lineHeight:4}}>الباعث</h3></button>
                  <button onClick={() => {
                    const bbb = new Promise ((resolve, reject) => {
                    setTimeout(() => {
                      resolve(n());
                    ...
                    .then (() => {n()})
                   }} style={{background:'rgb(255, 255, 255, 0)', border:'0', }}><h3 style={{background:'white',borderRadius:'50px', fontSize:"18px", height:'10vh',width:'14vw',textAlign:'center',lineHeight:4}}>الهدف/الوجهة</h3></button>
                  <button onClick={() => {
                    const bbb = new Promise ((resolve, reject) => {
                    setTimeout(() => {
                      resolve(n());
                    ...
                    .then (() => {n()})
                   }} style={{background:'rgb(255, 255, 255, 0)', border:'0', }}><h3 style={{background:'white',borderRadius:'50px', fontSize:"18px", height:'10vh',width:'10vw',textAlign:'center',lineHeight:4}}>الأعداء</h3></button>
                  <button onClick={() => {
                    const bbb = new Promise ((resolve, reject) => {
                    setTimeout(() => {
                      resolve(n());
                    ...
                    .then (() => {n()})
                   }} style={{background:'rgb(255, 255, 255, 0)', border:'0', }}><h3 style={{background:'white',borderRadius:'50px', fontSize:"18px", height:'10vh',width:'10vw',textAlign:'center',lineHeight:4}}>الأعوان</h3></button>
                  <button onClick={() => {
                    const bbb = new Promise ((resolve, reject) => {
                    setTimeout(() => {
                      resolve(n());
                    ...
                    .then (() => {n()})
                   }} style={{background:'rgb(255, 255, 255, 0)', border:'0', }}><h3 style={{background:'white',borderRadius:'50px',fontSize:"18px", height:'10vh',width:'10vw',textAlign:'center',lineHeight:4}}>المهارات</h3></button>
                  <button onClick={() => {
                    const bbb = new Promise ((resolve, reject) => {
                    setTimeout(() => {
                      resolve(n());
    ...
    <ul id='pul' ref={ref} >
      ...
      <li id='pli' style={{display:'flex', background:'#F5DF89'}}><img src='https://previews.123rf.com/images/summertime72/summertime722303/summertime72230300717/200999052-ai-generative-midjourney-illustration-of-a-fantasy-stairway-to-heaven.jpg' alt='' ></img><h1 style={{ color:'black'}}>A human by nature goes through various types of feeling as he walks upon his path to god. So without having signs at place that makes him at ease knowing that he is upon the truth he may not be able to gather his strength to continue on this path. Not mentioning that there are ranks that vary between the beleivers, and for one to climb them there has to exist a criteria by which he can Identify them. And on this path exists various milestones that could be identified. </h1></li>
          ...
          {isTabletOrMobile &&<div>
              ...
              viewport={{once:true, amount: 0.8}}
              variants={cardVariants}
              style={{fontSize:'23px',textAlign:"center", color:"white",textShadow: '1px 1px 7px rgb(255 30 160 / 50%)', WebkitTextStroke: '1px 0b0e13' }}>  معلوم لدينا أن في كل قصة/مغامرة <br></br> العناصر التالية هي المحاور الأساسية</motion.h2>
              <motion.div initial="offscreen"
              whileInView="onscreen"
              ...
              style={{ textAlign:'center', direction:'rtl'}}>
                  <button onClick={() => {
                    ...
                    bbb.then ((val) => {handlemclick();})
                    .then (() => {n()})
                   }} style={{background:'rgb(255, 255, 255, 0)', border:'0', }}><h3 style={{background:'white',borderRadius:'50px', height:'6.5vh',width:'17vw',textAlign:'center',lineHeight:1.5}}>الشخصية <br></br> الرئيسية</h3></button>
                  <button onClick={() => {
                    const bbb = new Promise ((resolve, reject) => {
                    setTimeout(() => {
                      resolve(n());
                    ...
                    .then (() => {n()})
                   }} style={{background:'rgb(255, 255, 255, 0)', border:'0', }}><h3 style={{background:'white',borderRadius:'50px', height:'6vh',width:'19vw',textAlign:'center',lineHeight:1}}><br></br>الباعث</h3></button>
                  <button onClick={() => {
                    const bbb = new Promise ((resolve, reject) => {
                    setTimeout(() => {
                      resolve(n());
                    ...
                    .then (() => {n()})
                   }} style={{background:'rgb(255, 255, 255, 0)', border:'0', }}><h3 style={{background:'white',borderRadius:'50px', height:'6vh',width:'22vw',textAlign:'center',lineHeight:1}}><br></br>الهدف/الوجهة</h3></button>
                  <button onClick={() => {
                    const bbb = new Promise ((resolve, reject) => {
                    setTimeout(() => {
                      resolve(n());
                    ...
                    .then (() => {n()})
                   }} style={{background:'rgb(255, 255, 255, 0)', border:'0', }}><h3 style={{background:'white',borderRadius:'50px', height:'6vh',width:'15vw',textAlign:'center',lineHeight:1}}><br></br>الأعداء</h3></button> <br></br>
                  <button onClick={() => {
                    const bbb = new Promise ((resolve, reject) => {
                    setTimeout(() => {
                      resolve(n());
                    ...
                    .then (() => {n()})
                   }} style={{background:'rgb(255, 255, 255, 0)', border:'0', }}><h3 style={{background:'white',borderRadius:'50px', height:'6vh',width:'15vw',textAlign:'center',lineHeight:3.3}}>الأعوان</h3></button>
                  <button onClick={() => {
                    const bbb = new Promise ((resolve, reject) => {
                    setTimeout(() => {
                      resolve(n());
                    ...
                    .then (() => {n()})
                   }} style={{background:'rgb(255, 255, 255, 0)', border:'0', }}><h3 style={{background:'white',borderRadius:'50px', height:'6vh',width:'15vw',textAlign:'center',lineHeight:3.3}}>المهارات</h3></button>
                  <button onClick={() => {
                    const bbb = new Promise ((resolve, reject) => {
                    setTimeout(() => {
                      resolve(n());
